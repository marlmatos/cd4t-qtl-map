...
res = 34
fvf_filename = f"~/cd4_CellRegMap/002_interaction_analysis/results/results_042426/cis_eQTLS_allcells_one_lead_snp_per_gene_res{res}.csv"
...
#set outdirs
outdir = f"~/cd4_CellRegMap/002_interaction_analysis/results/results_042426/one_lead_snp_per_gene_res{res}_5factors/p_values"
