...
data.dir="/path/to/lab_group/sghatan/marlis_pj/coloc/"
# folder names
...
finemap <- fread("/gchm/home/USER/cd4_qtl_paper_figures/figure_1/data/eqtl_caqtl_finemapping_coloc_all.tsv",
...
cbpnet <- fread('/gchm/home/USER/cd4_chrombpnet/chrombpnet_model_b7/variant_prediction_scores/averaged_scores/average_cd4_tcells_AJ_common_variants.mean.variant_scores_significan.tsv',
                data.table = FALSE, stringsAsFactors = FALSE)
