...
cat("Reading data") 
out.dir="/path/to/home/cd4_qtl_paper_figures/figure_2_chrombpnet/plotting/"
#read the finemapped coloc res
summary_df<-read_delim("/path/to/home/cd4_qtl_paper_figures/figure_1/data/eqtl_caqtl_finemapping_coloc_all.tsv")
...
mafs<-fread("/path/to/home/cd4_QTL_analysis/01_genotype_snps_covar/02_genotype_covariates/analysis/002.v4_calculating_pcs_MAF5/CD4_all_chr_ashkenazi.363.AF1.QC.BA.king2.hwe.scrnaseq.annot.freq.frq")
...
# 
# peak_count_path <- "/path/to/home/ATAC-seq_analysis/diff_accesibility_ana/results/peak_counts/RAW_cd4_atac_peakcounts_ranges_scrna_union.csv"
# 
