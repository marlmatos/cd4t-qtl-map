...
# writeLines(variants, "/path/to/home/cd4_qtl_paper_figures/figure_2_chrombpnet/plotting/cbpnet_examples/variant_motifHits_plot.txt")

#var_file=fread("/path/to/home/cd4_qtl_paper_figures/figure_2_chrombpnet/plotting/cbpnet_examples/variant_motifHits_plot.txt", header = FALSE)
