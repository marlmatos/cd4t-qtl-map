.libPaths(c("/path/to/home/R/x86_64-pc-linux-gnu-library/4.4","/path/to/software/easybuild/software/R/4.4.1-gfbf-2023b/lib/R/library"))
...
filtered_peaks<-'/path/to/home/cd4_chrombpnet/data/inputs/peaks/merged_cd4_samples_peaks_no_blacklist.sorted.bed' #peakcall used for ChromBPNet
...
summary_df <- read_delim(
  "/path/to/home/cd4_qtl_paper_figures/figure_1/data/eqtl_caqtl_finemapping_coloc_all.tsv"
)
...
#caQTL finemapping
###### get caQTL finemap 
file_name_ca  = "/path/to/lab_group/sghatan/marlis_pj/coloc/coloc_results/ca_eqtl_coloc/chr7_coloc_results.csv"
