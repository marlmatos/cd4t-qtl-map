...
# input="/path/to/project/cd4_aging_project/data/ATAC-seq/atac_preprocessing/merged_library/peak_calling/MACS3/BAMPE/peaks_102024/cd4_atac_summits_peaks.narrowPeak"

# output="/path/to/project/cd4_aging_project/data/ATAC-seq/atac_preprocessing/STAR/MACS3/anthony_concensus_peaks/marli_processed_peaks.bed"

# chrom_sizes="/path/to/home/resources/genome/hg38.p14.chrom.sizes.fmtd"
