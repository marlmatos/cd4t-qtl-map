...
params {
    ...
    // Inputs / outputs
    results    = '/gcgl/USER/cd4_aging_project/data/ATAC-seq/atac_preprocessing'
    data       = '/gcgl/USER/cd4_aging_project/data/ATAC-seq/Project_LAP_15324_B01_NAN_Lane.2023-06-06/Sample_*/fastq/*.R{1,2}.fastq.gz'
