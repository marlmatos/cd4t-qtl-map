...
// Inputs / outputs
params.results   = '/gcgl/USER/cd4_aging_project/data/ATAC-seq/atac_preprocessing'
...
params.shifted_bams          = '/gcgl/USER/cd4_aging_project/data/ATAC-seq/atac_preprocessing/STAR/shifted_bams/*.bam'
params.shifted_bams_flagstat = '/gcgl/USER/cd4_aging_project/data/ATAC-seq/atac_preprocessing/STAR/samtools_stats/post-filtering/*.bfilt.orpham.bam.flagstat.txt'
params.bigwig                = '/gcgl/USER/cd4_aging_project/data/ATAC-seq/atac_preprocessing/STAR/bigwig/*.bigWig'
