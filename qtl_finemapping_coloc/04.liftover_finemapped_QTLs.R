...
system(paste0("tail -n +2 ", bed_file, " | /path/to/software/bedtools/bedtools-2.31.1/bin/intersectBed -wa -wb -a stdin -b /gchm_lab/collab/genome/dbsnp151_GRCh38p7/bed_chr_",
