...
OUTPUT_DIR=$HOME/cd4_chrombpnet/chrombpnet_model_b7/tfmodisco_motifs/from_count_contributions
...
meme=$HOME/cd4_chrombpnet/chrombpnet_model_b7/tfmodisco_motifs/motifs_database/JASPAR2022_CORE_vertebrates_non-redundant_pfms_meme.txt 
