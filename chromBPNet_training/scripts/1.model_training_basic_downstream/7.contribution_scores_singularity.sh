#!/bin/bash
#SBATCH --job-name=contribution_score         # Job name
...
#SBATCH --error=logs/contribution_score_%A_%a.err   # Error log with array job ID
...
#please note that this step might take longer than the trianing of the model itself
...
#  output directory 
OUTPUT_DIR=$HOME_DIR/cd4_chrombpnet/chrombpnet_model_b7/contribution_scores_bw/fold_${FOLD_ID}/
