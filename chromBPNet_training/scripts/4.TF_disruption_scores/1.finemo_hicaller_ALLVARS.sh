...
OUTPUT_DIR=$HOME_DIR/cd4_chrombpnet/chrombpnet_model_b7/motif_hit_calls/motifs_hits_ALLVARS

mkdir -p $OUTPUT_DIR

# Original variant file
variants=$HOME_DIR/cd4_chrombpnet/scripts/3.variant_scoring_TF_hits/input/converted_variants_inpeaks.tsv
