...
OUTPUT_DIR=$HOME/cd4_chrombpnet/chrombpnet_model_b7/variant_contribution_scores/perfold/fold_${FOLD_ID}/
mkdir -p $OUTPUT_DIR
...
shap_script=$HOME/packages/variant-scorer/src/variant_shap.py
# Define the directory containing your modified helpers.py
HELPERS_DIR="$HOME/packages/variant-scorer/src/utils"
