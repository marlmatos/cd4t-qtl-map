...
tmp_root  <- "/gcgl/USER/cd4_aging_project/data/ATAC-seq/atac_preprocessing/nextflow_tmp"   # parent dir containing d2/0d4dad* etc
list_file <- "~/ATAC-seq_analysis/ATACseq_nf-preprocessing/scripts/sleepy_murdock_locations.log"
