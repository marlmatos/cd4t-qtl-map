...
directory=f"/path/to/home/cd4_caQTL_analysis/variant_to_peak_QTL/run_012625_qc_aware_qsmooth_CPM_MAF5_FDR5_1MB/results/006_caQTLs/{type}_1mb"
os.makedirs(directory, exist_ok = True)
os.chdir(directory)

# define paths to data
plink_prefix_path = f"/path/to/home/cd4_caQTL_analysis/variant_to_peak_QTL/run_012625_qc_aware_qsmooth_CPM_MAF5_FDR5_1MB/results/004_genotypes/plink/per_chr_plink_files/chr{chr_num}_ashkenazi.362.AF1.QC.BA.king2.hwe.annot"
expression_bed = f"/path/to/home/cd4_caQTL_analysis/variant_to_peak_QTL/run_012625_qc_aware_qsmooth_CPM_MAF5_FDR5_1MB/results/003_inputs/{type}/{type}_cd4_atac_processed_peaks.bed"
covariates_file = f"/path/to/home/cd4_caQTL_analysis/variant_to_peak_QTL/run_012625_qc_aware_qsmooth_CPM_MAF5_FDR5_1MB/results/005_covariates/{type}/{type}_atac_covs_PCs_age_sex.txt"
