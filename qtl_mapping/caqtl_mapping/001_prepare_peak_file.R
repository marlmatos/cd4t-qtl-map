...
# Libraries
.libPaths("/path/to/home/R/x86_64-pc-linux-gnu-library")
library(edgeR)
library(DESeq2)
library(matrixStats)
library(qsmooth)
...
# Directories
root_dir <- "/path/to/home/scRNAseq/002_seurat_preprocessing/analysis/004_creating_seurat_objects_filtered_annotated/"
out_dir <- "/path/to/home/cd4_caQTL_analysis/variant_to_peak_QTL/run_012625_qc_aware_qsmooth_CPM_MAF5_FDR5_1MB/results/001_peaks/"
...
## Paths
peaks_counts <- "/path/to/home/ATAC-seq_analysis/diff_accesibility_ana/results/peak_counts/RAW_cd4_atac_peakcounts_ranges_scrna_union.csv"
peak_metadata <- "/path/to/home/ATAC-seq_analysis/diff_accesibility_ana/results/metadata/cd4_atac_metadata_scrna_union.csv"
...
ff <- FaFile("/path/to/home/resources/genome/hg38_gencode_PRI_align/GRCh38.primary_assembly_subset_masked.genome.fa")
...
# Read WGS samples
wgs_samples <- read.delim("/path/to/home/cd4_QTL_analysis/01_genotype_snps_covar/02_genotype_covariates/analysis/002.v4_calculating_pcs_MAF5/CD4_all_chr_ashkenazi.364.AF1.QC.BA.king2.hwe.annot.fam", header = F)
