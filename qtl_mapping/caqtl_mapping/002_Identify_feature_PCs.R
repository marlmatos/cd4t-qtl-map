...
#--------------------------
# Libraries
.libPaths("/path/to/home/backup_R/x86_64-pc-linux-gnu-library")
library(PCAForQTL)
library(data.table)
library(RNOmni)
library(dplyr)
...
# Directories
root_dir <- "/path/to/home/cd4_caQTL_analysis/variant_to_peak_QTL/run_012625_qc_aware_qsmooth_CPM_MAF5_FDR5_1MB/results/"
metadata_path <- "/path/to/home/ATAC-seq_analysis/diff_accesibility_ana/results/metadata/cd4_atac_metadata_scrna_union.csv"
...
seq_metrics<- read.csv("/path/to/project/cd4_aging_project/data/ATAC-seq/atac_preprocessing/STAR/atac_preprocessing_metrics_qc_combined.csv" )           
