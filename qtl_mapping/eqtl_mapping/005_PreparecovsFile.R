...
genotype <- read.table('/path/to/home/cd4_QTL_analysis/01_genotype_snps_covar/02_genotype_covariates/analysis/002.v3_calculating_pcs_MAF5/CD4_all_chr_ashkenazi.367.AF1.QC.BA.king2.hwe.ld.eigenvec', header = F) ### genotype PC are the same for all celltypes
