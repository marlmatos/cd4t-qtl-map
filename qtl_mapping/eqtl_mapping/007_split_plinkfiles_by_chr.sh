...
plink_file="/path/to/home/cd4_QTL_analysis/01_genotype_snps_covar/02_genotype_covariates/analysis/002.v4_calculating_pcs_MAF5/CD4_all_chr_ashkenazi.363.AF1.QC.BA.king2.hwe.scrnaseq.annot"  #this big plink file is the result of concatenating all preprocessed chr_vcfs from Sam's genotyping analysis
#sam's analysis can be found at /path/to/project/cd4_aging_project/data/LowPass_WGS/03.27.24_SamGhatan_QC/ashkenazi_vcf
...
OUTDIR="/path/to/home/cd4_QTL_analysis/01_genotype_snps_covar/02_genotype_covariates/analysis/002.v4_calculating_pcs_MAF5/"
