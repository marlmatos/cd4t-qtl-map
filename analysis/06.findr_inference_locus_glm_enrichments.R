# ============================================================
# Causal Inference Test for Mediated QTLs (Findr) - Locus-level enrichment tests
# Author: M Matos, 2025-01-25
...
peak_coords <- read_tsv(
  "/gcgl/USER/cd4_aging_project/data/ATAC-seq/atac_preprocessing/merged_library/peak_calling/MACS3/BAMPE/peaks_102024/cd4_atac_padded_summits_peaks.bed",
  col_names = NULL,
