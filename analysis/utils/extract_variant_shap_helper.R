...
# --- example usage ---
# h5_file_path <- "/path/to/home/cd4_chrombpnet/chrombpnet_model_b7/variant_contribution_scores/averaged_cd4_tcells_AJ_common_variants.shap.counts.h5"
...
#   chrom_sizes_path = "/path/to/home/resources/genome/hg38.chrom.sizes",
#   out_dir   = "bw_out",
#   prefix    = "shap",
#   export_delta = TRUE
# )